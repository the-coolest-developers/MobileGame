...
namespace Controllers.UI_Controllers
{
    public class GameMenu : MonoBehaviour
    {
        ...
        private GameObject GameInteractiveMenuObject { get; set; }
        ...
        private void Start()
        {
            ...
            GameInteractiveMenuObject = GameObject.Find("GameInteractiveMenu");
            ...
            GameInteractiveMenuObject.SetActive(false);
        }
        ...
        public void InteractiveMenuButton_Click()
        {
            ...
            GameInteractiveMenuObject.SetActive(true);
            MenuButtonObject.SetActive(false);
            DimmedBackgroundObject.SetActive(true);
        }
    }
